...
RUN cd /home/rstudio && wget https://github.com/RichardPilbery/SPRAINED/archive/master.tar.gz && tar xvfz master.tar.gz && rm master.tar.gz && chown -R rstudio:rstudio /home/rstudio/SPRAINED && chmod 755 /home/rstudio/SPRAINED
